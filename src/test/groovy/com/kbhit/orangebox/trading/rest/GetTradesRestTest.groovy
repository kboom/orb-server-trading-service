...
class GetTradesRestTest extends RestTest {
    ...
    def "Gets single trade"() {
        ...
        response.then().statusCode(200)
                ...
                .body("initialBid.bidder.login", equalTo("agatha"))
                ...
                .body("latestBid.bidder.login", equalTo("greg"))
                ...
                .body("historicBids[0].bidder.login", equalTo("agatha"))
                ...
                .body("historicBids[1].bidder.login", equalTo("greg"))
